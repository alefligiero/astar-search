...
public class AStar {
	...
	public void recursiveSearch(Vertex v) {
		...
		if (v.getDistance() == 0) {
			...
			// Calling the function again with the city with the smallest heuristic distance + edge distance from the destination (position zero)
